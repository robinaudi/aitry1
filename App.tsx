...
const App: React.FC = () => {
    ...
    // 2. Fetch Data from Firestore (DISABLED to enforce local content updates)
    useEffect(() => {
        // For now, we are using local content as the source of truth to ensure code revisions take effect.
        // If you want to re-enable Cloud CMS content, uncomment the fetch logic below.
        setLoading(false);
                            ...
                            <div>
                                ...
                                <div className="mb-10 space-y-6">
                                    ...
                                    {content.education.map((edu, index) => (
                                        <div key={index} className={`p-4 border rounded-lg backdrop-blur-sm ${isDark
                                    ...
                                    {content.teaching.map((teach, index) => (
                                        <div key={index} className={`p-4 border rounded-lg backdrop-blur-sm ${isDark
                                            ...
                                            <div className={`flex justify-between items-start mb-1`}>
                                                ...
                                                <div className={`text-xs px-2 py-1 rounded ${isDark
